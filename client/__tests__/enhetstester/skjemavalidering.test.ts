...
describe("dato parsing", () => {
    ...
    test("kan parse datoer fra en string", () => {
        ...
        expect(
            datoSchema.safeParse("2022-01-12T00:00:00.000Z").success,
        ).toBeTruthy();
    });
    ...
    test("kan parse datoer som inngår i større skjemaer", () => {
        ...
        const safeParseResultat =
            iaSakshendelseSchema.safeParse(iaSakshendelseMock);
...
describe("iasak parsing", () => {
    test("kan parse iasak med null felter", () => {
        ...
        expect(safeparseResultat.success).toBeTruthy();
        expect(
            safeparseResultat.success && safeparseResultat.data.eidAv === null,
        ).toBeTruthy();
    });
});
