...
describe("Finn rett 'standardmodul' frå IATjeneste", () => {
    test("Finn en modul når vi har 1 modul per IA-tjeneste", () => {
        ...
        expect(finnAktivModulFraIATjeneste(iaTjeneste.id.toString(), moduler)).toStrictEqual(
            {
                id: 15,
                iaTjeneste: 1,
    ...
    test("Finn modul med lavest ID når vi har flere moduler per IA-tjeneste", () => {
        ...
        expect(finnAktivModulFraIATjeneste(iaTjeneste.id.toString(), mangeModuler)).toStrictEqual(
            {
                id: 15,
                iaTjeneste: 1,
                navn: "Redusere sykefravær",
