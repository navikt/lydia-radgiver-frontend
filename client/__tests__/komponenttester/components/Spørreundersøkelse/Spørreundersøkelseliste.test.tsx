import { SpørreundersøkelseProvider, SpørreundersøkelseProviderProps } from '../../../../src/components/Spørreundersøkelse/SpørreundersøkelseContext';
	...
	return (
		<SamarbeidProvider samarbeid={dummySamarbeid}>
			<VirksomhetContext.Provider value={{
				...
				setFane: (fane: string) => { console.log('setter fane til', fane); }
			}}>
				<SpørreundersøkelseProvider
					...
					sisteOpprettedeSpørreundersøkelseId={sisteOpprettedeSpørreundersøkelseId ?? sisteOpprettedeId}
					setSisteOpprettedeSpørreundersøkelseId={setSisteOpprettedeSpørreundersøkelseId ?? setSisteOpprettedeId}
...
describe('Spørreundersøkelseliste', () => {
	...
	it("Rendrer korrekt", () => {
		...
		expect(screen.getAllByRole("heading", { name: "Behovsvurdering" })).toHaveLength(6);
	});
});