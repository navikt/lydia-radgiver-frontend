...
export const SykefraværsstatistikkVirksomhet = ({ sykefraværsstatistikk } : Props ) => {
    ...
    <HorisontalFlexMedGap>
        <StatistikkBoks verdi={prosentSomDesimal(sykefraværsstatistikk.sykefraversprosent)} tittel="Sykefravær" bakgrunnsfarge={"#A0A0A0"} type="percent" />
        ...
        <StatistikkBoks verdi={sykefraværsstatistikk.tapteDagsverk} tittel="Tapte dagsverk" bakgrunnsfarge={"#A0A0A0"} type="decimal" />
