...
import BegrunnelserForIkkeKunne, { usePrettyType } from "./BegrunnelserForIkkeKunne";
...
function Handlingsknapper({ onCancel, onConfirm, type, erTillatt }: { onCancel: () => void, onConfirm: () => void, type: MuligSamarbeidsgandling, erTillatt?: boolean }) {
	...
	return (
		<Modal.Footer>
			<Button variant="primary" onClick={onConfirm} disabled={!erTillatt}>{prettyType.capitalized} samarbeid</Button>
