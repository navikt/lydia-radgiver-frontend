...
export default {
    ...
    decorators: [
        (Story) => (
            <div style={{ width: 230 / 16 + "px" }}>
                {" "}
                {/* Min-width StatistikkBoks-container */}
                <Story />
            </div>
        ),
    ],
...
export const SykefravarsprosentMedVerdiSisteKvartal = () => (
    <Statistikkboks
        tittel="Sykefravær"
        verdi="14.0%"
        verdiSisteKvartal={{ verdi: "13.4%", år: 2023, kvartal: 1 }}
        helpTekst="Sykefraværsprosent siste 4 kvartal"
    />
);
...
export const TapteDagsverkMedVerdiSisteKvartal = () => (
    <Statistikkboks
        ...
        verdi="142"
        verdiSisteKvartal={{ verdi: "11", år: 2023, kvartal: 1 }}
...
export const MuligeDagsverkMedVerdiSisteKvartal = () => (
    <Statistikkboks
        ...
        verdiSisteKvartal={{ verdi: "345", år: 2023, kvartal: 1 }}
...
export const Gradering = () => (
    <Statistikkboks
        ...
        verdiSisteKvartal={{ verdi: "14%", år: 2023, kvartal: 1 }}
