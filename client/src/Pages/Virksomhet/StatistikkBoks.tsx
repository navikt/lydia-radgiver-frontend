...
const percentFormatter: Formatter = new Intl.NumberFormat('nb-NO', { maximumFractionDigits: 1, style: 'percent' })
const decimalFormatter: Formatter = new Intl.NumberFormat('nb-NO', { maximumFractionDigits: 0, style: 'decimal' })
