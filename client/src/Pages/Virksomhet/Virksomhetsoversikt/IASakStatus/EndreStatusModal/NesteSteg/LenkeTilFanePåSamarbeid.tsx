...
export default function LenkeTilFanePåSamarbeid({
    ...
    return (
        <Link
            as={NavLink}
            to={`/virksomhet/${virksomhet.orgnr}/sak/${virksomhet.aktivtSaksnummer}/samarbeid/${samarbeidId}?fane=${fane}`}
            onClick={onClick}
        >
            {children}
        </Link>
...
export function LenkeTilBehovsvurderingFane({
    samarbeidId,
    alleSamarbeid,
    onClick,
}: {
...
export function LenkeTilEvalueringsFane({
    samarbeidId,
    alleSamarbeid,
    onClick,
}: {
...
export function LenkeTilSamarbeid({
    ...
    return (
        <Link
            as={NavLink}
            to={`/virksomhet/${virksomhet.orgnr}/sak/${virksomhet.aktivtSaksnummer}/samarbeid/${samarbeidId}`}
            onClick={onClick}
        >
            {children}
        </Link>
