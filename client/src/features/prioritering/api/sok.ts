...
import { getSykefraværsstatistikkUrl } from "@/api/lydia-api/paths";
import {
    getStatusoversiktUrl,
    getSykefraværsstatistikkAntallTreffUrl,
} from "@/api/lydia-api/paths";
import { filterverdierPath } from "@/api/lydia-api/paths";
...
import { statusoversiktListeResponsSchema } from "@features/sak/types/statusoversikt";
import { virksomhetsoversiktListeResponsSchema } from "@features/virksomhet/types/virksomhetsoversikt";
