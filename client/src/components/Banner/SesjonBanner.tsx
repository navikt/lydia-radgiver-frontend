...
export const SesjonBanner = ({ tokenUtløper }: Props) => {
    const [tidIgjenAvSesjon, setTidIgjenAvSesjon] = useState(
        tokenUtløper - Date.now(),
    );
...
const SesjonenLøperUt = ({ tidIgjenAvSesjon }: SesjonenLøperUtProps) => {
    ...
    return (
        <Banner variant="warning">
            <BodyShort>
                Sesjonen din løper ut om {gjenværendeSekunder} sekunder.
                Vennligst trykk på <Link href={redirectUrl}>denne lenken</Link>{" "}
                for å logge inn på nytt
            </BodyShort>
        </Banner>
    );
};
...
const SesjonenErUtløpt = () => {
    return (
        <Banner variant="error">
            <BodyShort>
                Sesjonen din er utløpt. Vennligst trykk på{" "}
                <Link href={redirectUrl}>denne lenken</Link> for å logge inn på
                nytt
            </BodyShort>
        </Banner>
    );
