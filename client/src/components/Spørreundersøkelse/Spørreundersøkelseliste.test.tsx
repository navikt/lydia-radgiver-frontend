...
import Spørreundersøkelseliste from "./Spørreundersøkelseliste";
...
function DummySpørreundersøkelseProvider({
    ...
    brukerrolle?: string;
} & Partial<SpørreundersøkelseProviderProps>) {
...
describe("Spørreundersøkelseliste", () => {
    ...
    describe("status: OPPRETTET", () => {
        const antallOpprettet = dummySpørreundersøkelseliste.filter(
        ...
        it("Viser riktig status", () => {
            ...
            expect(screen.getAllByText("Opprettet")).toHaveLength(
                antallOpprettet,
            );
        });
        ...
        it("Viser riktig knapper", () => {
            ...
            ).toHaveLength(antallOpprettet);
            expect(
                screen.getAllByRole("button", { name: "Forhåndsvis" }),
            ).toHaveLength(antallOpprettet);
        });
        it("Gir ikke knapp for lesebruker", () => {
            ...
            expect(
                screen.queryByRole("button", { name: "Forhåndsvis" }),
            ).not.toBeInTheDocument();
        });
    });
    describe("status: PÅBEGYNT", () => {
        const antallPåbegynt = dummySpørreundersøkelseliste.filter(
        ...
        it("Viser riktig status", () => {
            ...
            expect(screen.getAllByText("Påbegynt")).toHaveLength(
                antallPåbegynt,
            );
        });
        it("Gir riktige knapper", () => {
            const dummyBehovsvurderingerMedPåbegynt =
                dummySpørreundersøkelseliste
                    .filter(
                        ({ status, type }) =>
                            status === "PÅBEGYNT" && type === "BEHOVSVURDERING",
                    )
                    .map((undersøkelse) => ({
                        ...undersøkelse,
            ...
            const antallPåbegyntInnenFrist =
                dummyBehovsvurderingerMedPåbegynt.length;

            render(
                <DummySpørreundersøkelseProvider
                    spørreundersøkelseliste={dummyBehovsvurderingerMedPåbegynt}
                >
                    <Spørreundersøkelseliste />
                </DummySpørreundersøkelseProvider>,
            );
            ...
            expect(
                screen.getAllByRole("button", { name: "Fortsett" }),
            ).toHaveLength(antallPåbegyntInnenFrist);
            expect(
                screen.getAllByRole("button", { name: "Fullfør" }),
            ).toHaveLength(antallPåbegyntInnenFrist);
            expect(
                screen.getAllByRole("button", {
                    name: "Slett behovsvurdering",
                }),
            ).toHaveLength(antallPåbegyntInnenFrist);
        });
        ...
        it("Gir ikke knapp for utgått spørreundersøkelse", () => {
            ...
            expect(antallPåbegyntInnenFrist).toBeGreaterThan(0);
            expect(
                screen.queryByRole("button", { name: "Fortsett" }),
            ).not.toBeInTheDocument();
            expect(
                screen.queryByRole("button", { name: "Fullfør" }),
            ).not.toBeInTheDocument();
            expect(
                screen.queryByRole("button", { name: "Slett behovsvurdering" }),
            ).not.toBeInTheDocument();
        });
        it("Gir ikke knapp for lesebruker", () => {
            const dummyBehovsvurderingerMedPåbegynt =
    ...
    describe("status: AVSLUTTET", () => {
        const antallAvsluttet = dummySpørreundersøkelseliste.filter(
            ({ status }) => status === "AVSLUTTET",
        ).length;
        const dummySpørreundersøkelselisteMedFåSvar =
            dummySpørreundersøkelseliste
                .filter(({ status }) => status === "AVSLUTTET")
                .map((undersøkelse, index) => {
                    if (index === 0) {
                        return {
                            ...undersøkelse,
        ...
        it("Viser riktig status", () => {
            ...
            expect(screen.getAllByText("Fullført")).toHaveLength(
                antallAvsluttet,
            );
        });
        it("Gir sletteknapp hvis undersøkelse har for få svar", () => {
            render(
                <DummySpørreundersøkelseProvider
                    spørreundersøkelseliste={
                        dummySpørreundersøkelselisteMedFåSvar
                    }
                >
                    <Spørreundersøkelseliste />
                </DummySpørreundersøkelseProvider>,
            ...
            expect(antallAvsluttet).toBeGreaterThan(0);
            expect(
                screen.getAllByRole("button", { name: "Slett" }),
            ).toHaveLength(1);
        });
        ...
        it("Gir ikke sletteknapp hvis undersøkelse har nok svar", () => {
            const dummySpørreundersøkelselisteMedNokSvar =
                dummySpørreundersøkelseliste
                    .filter(({ status }) => status === "AVSLUTTET")
                    .map((undersøkelse) => ({
                        ...undersøkelse,
            ...
            render(
                <DummySpørreundersøkelseProvider
                    spørreundersøkelseliste={
                        dummySpørreundersøkelselisteMedNokSvar
                    }
                >
                    <Spørreundersøkelseliste />
                </DummySpørreundersøkelseProvider>,
            ...
            expect(
                dummySpørreundersøkelselisteMedNokSvar.length,
            ).toBeGreaterThan(0);
            expect(
                screen.queryByRole("button", { name: "Slett" }),
            ).not.toBeInTheDocument();
        ...
        it("Viser resultat", () => {
            const antallAvsluttetMedResultat =
                dummySpørreundersøkelseliste.filter(
                    ({ status, harMinstEttResultat }) =>
                        status === "AVSLUTTET" && harMinstEttResultat,
                ).length;
            render(
                <DummySpørreundersøkelseProvider>
                    <Spørreundersøkelseliste />
            ...
            expect(antallAvsluttet).toBeGreaterThan(0);
            const visMerKnapper = screen.getAllByRole("button", {
                name: "Vis mer",
            });
    ...
    describe("status: SLETTET", () => {
        const dummySpørreundersøkelselisteMedSlettet = [
            ...dummySpørreundersøkelseliste,
        ];
        ...
        const antallSlettet = dummySpørreundersøkelselisteMedSlettet.filter(
        ...
        it("Viser ikke rad", () => {
            render(
                <DummySpørreundersøkelseProvider
                    spørreundersøkelseliste={
                        dummySpørreundersøkelselisteMedSlettet
                    }
                >
                    <Spørreundersøkelseliste />
                </DummySpørreundersøkelseProvider>,
