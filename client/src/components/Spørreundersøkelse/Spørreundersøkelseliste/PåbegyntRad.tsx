...
import { avsluttSpørreundersøkelse, slettSpørreundersøkelse } from '../../../api/lydia-api/spørreundersøkelse';
...
export default function PåbegyntRad({
	...
	const [bekreftFullførBehovsvurderingModalÅpen, setBekreftFullførBehovsvurderingModalÅpen] = React.useState(false);
	...
	const { iaSak, brukerRolle, kanEndreSpørreundersøkelser, hentSpørreundersøkelserPåNytt } = useSpørreundersøkelse();
	const {
