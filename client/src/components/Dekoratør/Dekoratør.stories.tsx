        ...
        handlers: [
            http.get(`${virksomhetAutocompletePath}`, ({ request }) => {
                ...
                return HttpResponse.json(
                    søketekst === null
                        ? []
                        : virksomhetAutocompleteMock.filter(
                              (virksomhet) =>
                                  virksomhet.navn.startsWith(søketekst) ||
...
export const IkkeAutentisert = () => (
    <Dekoratør brukerInformasjon={brukerMedTokenSomHolderPåÅLøpeUt} />
);
