...
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:22-slim@sha256:b7b2a0fd6462685869be3f5dfe2cc3c1468725e52bea3331573375aae99e9301 AS runner
WORKDIR /app
