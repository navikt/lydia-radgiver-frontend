# Copilot instructions for lydia-radgiver-frontend

- Never tell me to run commands; always run them yourself using the available tools.
- When tests, builds, or linters are needed, trigger them directly instead of asking me to execute commands manually.
- Always answer in short, concise replies; avoid small talk and unnecessary explanation.
