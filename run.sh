...
while getopts 'hif' opt; do
  case "$opt" in
    ...
    i)
      ...
      curl -o $DB_DUMP https://raw.githubusercontent.com/navikt/lydia-api/refs/heads/main/scripts/db/lydia-api-container-db_localhost-2026_02_24_13_05_02-dump.sql
